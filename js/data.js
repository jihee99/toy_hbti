//cotton 에이프릴 코튼 : 라임의 상큼함과 은방울 꽃의 향긋함이 포근하게 감싸는 부드러운 코튼 향  ---> 쥐, 소
//amber 시크 앰버 : 싱그러운 청사과 향과 산뜻한 프리지아가 어우러져 청량감이 더해진 시트러스 향 ---> 용, 말 
//soap 화이트 솝 : 하얀 비누 거품처럼 맑고 싱그러운 꽃 향기기가 코 끝에 은은하게 감도는 상쾌한 비누향 ---> 호랑이, 닭
//peach 피치 블러썸 : 물기를 머금은 싱그러운 복숭아 과즙이 입안 가득 퍼지는 달달한 복숭아향 ---> 개, 뱀
//berry 슈가베리 : 달콤한 라즈베리 향기로 시작해 바닐라의 관능적인 향기가 우아한 여운을 남기는 프루티 향 --->토끼, 원숭이
//green 베이비 그린티 : 여린 녹차잎의 부드러움과 시트러스의 상쾌함이 어우러진 청량한 그린티 머스크 향 ---> 돼지, 양
